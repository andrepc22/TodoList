...
Proyecto de aplicación web construido en Python con el framework de Flask, con gestión de base de datos MySQL, además de uso de HTML y CSS; todo bajo una arquitectura MVC.
